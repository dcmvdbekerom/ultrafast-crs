...
c = FancyBboxPatch((28,1), 1,1, boxstyle="round,pad=0.5", fc="none", ec='k', zorder=4, alpha=0.5, lw=1)
ax0.add_patch(c)
ax0.annotate('', xy=(28+1.5,1.5), xytext=(36,1.5), arrowprops=dict(arrowstyle='<-', ec='k', alpha=0.5), zorder=4, alpha=0.5)



plt.tight_layout()
plt.subplots_adjust(left=0.045, wspace=0.320, hspace=0.250)
...
plt.savefig('output/Figure1_grid.png', dpi=300)
plt.savefig('output/Figure1_grid.pdf', dpi=300)