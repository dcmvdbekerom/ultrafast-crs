...
def annotate(_ax,x,y,s, bbox_fmt=dict(facecolor='gray', edgecolor='k', alpha=0.8, boxstyle='circle')):
    _ax.text(x,y,s, c='w',fontsize=16, ha='center', va='center', transform = _ax.transAxes, bbox=bbox_fmt)

annotate(ax, 0.125, 0.175, '1')
annotate(ax, 0.75, 0.75, '2')
annotate(s3_ax, 0.9, 0.6, '3')
annotate(s4_ax, 0.9, 0.4, '4')
annotate(s1_ax, 0.9, 0.6, '5')
annotate(s2_ax, 0.9, 0.4, '6')
annotate(b1_ax, 1.1, 0.6, '7')
annotate(b2_ax, 1.1, 0.4, '8')
